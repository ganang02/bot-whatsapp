     ...
     client.DeleteMessage(ah, botNumber)
      ...
      case prefix+'m': case prefix+'menu':{//Rfz XM
           client.sendMessage(from, { react: { text: "⏱️", key: msg.key }})
             ...
             let caption = '© XilverMoods - By @gannn298_'
             ...
             let sourceUrl =  'https://instagram.com/gannn298_'
             let mediaUrl = 'https://instagram.com/gannn298_'                            
        ...
        case prefix+'sendbugkontak':{
         ...
         case prefix+'swm': case prefix+'stickerwm': case prefix+'wm': case prefix+'curi': case prefix+'colong': case prefix+'take': {  
            ...
            let text2 = q.split("|")[1]
              ...
              if (!text1) return msg.reply(`Contoh! : ${order + ' ' + 'tes|gann'}`)    
              if (!text2) return msg.reply(`Contoh! : ${order + ' ' + 'tes|gann'}`)
                client.sendMessage(from, { react: { text: "⏱️", key: msg.key }})
          try{ 
      ...
      let aud = {
          ...
          contextInfo:{
           externalAdReply:{
             ...
             thumbnail: thumb,
             sourceUrl: "https://instagram.com/gannn298_",
             mediaUrl: "https://instagram.com/gannn298_",
